...
(?=.*[0-9]) checks if there's at least one number in the string
(?=.*_) checks if there's at least one underline character in the string
[a-zA-Z0-9_]+ checks if the rest of the string consists only of Latin letters, numbers, and underlining characters
$ matches the end of the string
        */
        if (!login.matches("^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*_)[a-zA-Z0-9_]+$"))
